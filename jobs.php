...
required="required" value="" name="name" class="form-
...
$sql = "SELECT jobs.jobid,jobs.name,categories.name as
'catname',jobs.desciption,jobs.date,jobs.salary,jobs.skill,j
obs.timing,jobs.location
from jobs
...
$salary = $_POST['salary'];
// print_r($_POST);
if(mysqli_query($con,"INSERT INTO `jobs`( `name`,
`desciption`, `skill`, `timing`, `date`, `salary`,
`location`, `catid`) VALUES
('$name','$description','$skill','$timing','$date','$salary'
,'$location','$catid')")){
